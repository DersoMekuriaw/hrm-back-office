...
import { ACADEMIC_RANKS, Employee, LeaveRequest } from '@/types/employee.type';
...
const EmployeeView = ({
  ...
  const rank = ACADEMIC_RANKS?.find((rank) => rank.id === employee.academicRankId);
        ...
        {activeTab === 'details' && (
          <div className="grid grid-cols-1 gap-x-4 gap-y-8 sm:grid-cols-2">
            ...
            <div className="sm:col-span-1">
              ...
              <dd className="mt-1 text-sm text-gray-900">{position? position : '—'}</dd>
            </div>
            <div className="sm:col-span-1">
            ...
            <div className="sm:col-span-1">
              ...
              <dd className="mt-1 text-sm text-gray-900">
                {rank?.baseSalary ? `${rank?.baseSalary.toLocaleString()} ETB` : '—'}
              </dd>
            </div>
          </div>
        )}
