      ...
      <div className="bg-white pb-2 flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-2">
        ...
        {onAddNew && (
          <Button 
            ...
            className="bg-blue-600 hover:bg-blue-700 text-white px-2 py-1 rounded-lg  font-medium"
          >
            New
          </Button>
        )}
        ...
        {onSearch && (
          <div className="flex items-center gap-2 w-full md:w-auto">
            ...
            />
            <select className="border border-gray-300 rounded-lg px-3 py-1 bg-white focus:outline-none focus:ring-2 focus:ring-blue-500">
                    ...
                    <td className="px-1 py-4 whitespace-nowrap text-center">
                      <div className="flex justify-center space-x-2 md:opacity-0 group-hover:opacity-100 transition-opacity duration-200">
                        ...
                        {onEdit && (
                          ...
                          >
                            <IconEdit className="text-green-600" size={16} />
                          </Button>
                        )}
                        {onDelete && (
                          <Button
